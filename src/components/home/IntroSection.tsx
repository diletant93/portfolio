    ...
    return (
        <div className="intro-section">
            <div className="intro-item">
                ...
                <Link to={'/bio'}>
                    <Button className="shadcn-button text-2xl uppercase hover:-translate-y-2 w-60 h-20">BIO</Button>
                </Link>
            </div>
            ...
            <div className="intro-item ">
                ...
                <Link to={'/abilities'}>
                    <Button className="shadcn-button text-2xl uppercase hover:-translate-y-2 w-60 h-20">Abilities</Button>
                </Link>
            </div>
            ...
            <div className="intro-item ">
                ...
                <Link to={'/prospects'}>
                    <Button className="shadcn-button text-2xl uppercase hover:-translate-y-2 w-60 h-20">Prospects</Button>
                </Link>
            </div>
            <ScrollingListRight items={kanjiArray} renderItem={renderNumber} />
        </div>
